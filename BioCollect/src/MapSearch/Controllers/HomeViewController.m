...
- (MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id < MKAnnotation >)annotation
{
    ...
    [leftButton setImage:[UIImage imageNamed:@"info_filled-25"] forState:UIControlStateNormal];
    [self loadStreetViewForCoordinate:__annotation.coordinate completion:^(NSString *panoId) {
        __annotation.panoId = panoId;
        [leftButton setImage:[UIImage imageNamed:@"icon_street_view"] forState:UIControlStateNormal];
